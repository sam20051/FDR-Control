...
plt.title("Small Number of Hypotheses with Strong Signals")
plt.legend()
plt.show()
```
...
print("Interpretation: BH discovers the most signals, while Bonferroni is very conservative. BY is in between but closer to Bonferroni.")
...
print("Interpretation: All methods control false discoveries well. Bonferroni and BY have very low FDP, while BH has a slightly higher but still acceptable FDP.")
...
print("Interpretation: BH has the highest power, meaning it detects the most true signals. BY has lower power than BH due to its conservativeness under dependence, while Bonferroni has the lowest power, missing many true discoveries.")
```
