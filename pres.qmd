...
For example, if we have 1000 tests and want to maintain an overall α of 0.05, the Bonferroni threshold would be 0.00005, which is extremely strict and often leads to very few discoveries, even when there are true effects present.
